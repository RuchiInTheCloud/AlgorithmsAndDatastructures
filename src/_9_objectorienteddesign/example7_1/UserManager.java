...
public class UserManager {
    ...
    private HashTable<Integer, User> usersById = new HashTable<>();
    private HashTable<String, User> usersByAccountName = new HashTable<>();
    private HashTable<Integer, User> onlineUsers = new HashTable<>();
